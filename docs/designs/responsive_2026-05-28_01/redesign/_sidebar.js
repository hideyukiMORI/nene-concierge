...
(function () {
  ...
  if (!document.querySelector('.nca-mobile-menu')) {
    const btn = document.createElement('button');
    btn.className = 'nca-mobile-menu';
    ...
    overlay.className = 'nca-sidebar-overlay';
    document.body.appendChild(overlay);

    const close = () => document.body.classList.remove('nca-menu-open');
    btn.addEventListener('click', () => document.body.classList.toggle('nca-menu-open'));
