...
use NeNeConcierge\Http\RuntimeServiceProvider;
use PHPUnit\Framework\TestCase;
use ReflectionMethod;

/**
 * The local JWT secret must fail closed in production when
 * NENE2_LOCAL_JWT_SECRET is unset (or empty), rather than falling back to the
